...
- [# FIXME: new constant names: INPUT_BEAD_ID, INPUT_CONTENT_HASH, INPUT_FREEZE_TIME](https://github.com/e3krisztian/bead/blob/renames/bead/pkg/meta.py#L40)
- [# FIXME: rename `version` to `content-hash`](https://github.com/e3krisztian/bead/blob/renames/bead/pkg/meta.py#L42)
- [# FIXME: new constant names: FREEZE_TIME, FREEZE_NAME](https://github.com/e3krisztian/bead/blob/renames/bead/pkg/meta.py#L60)
