...
- [FIXME: use workspace.get_branch(input.name) as first parameter](https://github.com/e3krisztian/bead/blob/break-chains-by-name/bead_cli/input.py#L215)
...
- [TODO: Box: support user maintained directory hierarchy](https://github.com/e3krisztian/bead/blob/break-chains-by-name/bead/box.py#L90)
- [TODO: log/report problem](https://github.com/e3krisztian/bead/blob/break-chains-by-name/bead/box.py#L143)
