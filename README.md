...
- [label: str  # FIXME: make label an InputSpec (could make phantoms from edges!)](https://github.com/e3krisztian/bead/blob/break-chains-by-name/bead_cli/web.py#L295)
...
- [XXX: when an input edge has been eliminated, it will have no effect on the](https://github.com/e3krisztian/bead/blob/break-chains-by-name/bead_cli/web.py#L443)
