...
- [XXX: when an input edge has been eliminated, it will have no effect on the](https://github.com/e3krisztian/bead/blob/break-chains-by-name/bead_cli/web/sketch.py#L145)
