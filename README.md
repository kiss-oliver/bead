...
- [label: str  # FIXME: make label an InputSpec (could make phantoms from edges!)](https://github.com/e3krisztian/bead/blob/break-chains-by-name/bead_cli/web.py#L296)
...
- [TODO: move to test_graphviz.py](https://github.com/e3krisztian/bead/blob/break-chains-by-name/bead_cli/test_web.py#L10)
...
- [XXX: test as_dot() / web command](https://github.com/e3krisztian/bead/blob/break-chains-by-name/bead_cli/test_web.py#L206)
...
- [XXX: when an input edge has been eliminated, it will have no effect on the](https://github.com/e3krisztian/bead/blob/break-chains-by-name/bead_cli/web.py#L444)
