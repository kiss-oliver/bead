...
- [FIXME: use mapped input name as phantom.name](https://github.com/e3krisztian/bead/blob/break-chains-by-name/bead_cli/web.py#L290)
- [FIXME: verify presence by mapped input name and content_id](https://github.com/e3krisztian/bead/blob/break-chains-by-name/bead_cli/web.py#L288)
